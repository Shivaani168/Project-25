...
function setup() {
  ...
  side1=new Side(width-200,height-30,200,20);
	side2=new Side(width-310,height-140,20,240);
  side3=new Side(width-90,height-140,20,240);
...
function draw() {
  ...
  //image(dustbinImage,width-330,height-270,260,240);
  side2.display();
  side3.display();
...
function keyPressed(){
if(keyCode===UP_ARROW){
Matter.Body.applyForce(crushedPaper.body,crushedPaper.body.position,{x:257,y:-257})
}
}
